...
(fn add-wibar-to-screen [s]
    ...
    (set s.mytasklist
         (awful.widget.tasklist {:screen s
                                 ...
                                 :buttons [(b [] 1
                                           ...
                                           (b [] 3
                                              (cw.mk-client-menu-toggle-fn false))
                                           (b [] 4
                                              (fn [_c]
  ...
  (let [size s.mywibox.height]
    (s.mywibox:setup (box-props {:layout wibox.layout.align.horizontal}
